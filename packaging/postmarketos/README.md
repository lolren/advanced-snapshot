...
`0376f68c6808517fdc368d8e92ce67a0463ce960`, and Cargo dependencies are
...
APK_VERIFY_TOOL="$HOME/.local/var/pmbootstrap/apk.static" \
  ...
  ~/.local/var/pmbootstrap/packages/edge/aarch64/advanced-snapshot-0.1.0-r34.apk \
  ~/.local/var/pmbootstrap/packages/edge/aarch64/snapshot-50.0-r3.apk \
  ~/.local/var/pmbootstrap/packages/edge/aarch64/advanced-snapshot-lang-0.1.0-r34.apk
```

Package revision r34 contains the manual shutter/analogue-gain UI, bounded
...
The r34 UI keeps the labelled Image Controls entry in a direct toolbar above
...
commit `0376f68c6808517fdc368d8e92ce67a0463ce960`. When the preview is handed
off to the standalone full-resolution still stream, r34 reapplies the last tap
...
The reference r34 build produced main APK SHA-256
